...
class CLI:
    ...
    def play(self):
        ...
        """
        print(
            "Tervetuloa pelaamaan miinaharavaa! Anna koordinaatit niin voit avata ruudun.")
        ...
        while True:
            ...
            inp = input(
                "Kirjoita F asettaaksesi lipun tai R poistaaksesi lipun. Muulla syötteellä skipataan lipun asettaminen")
            try:
                index = self.ask_coordinates()
            except:
                continue
